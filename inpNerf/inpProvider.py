...
from .utils inpImport inpGet_rays
...
inpClass InpNeRFDataset:
    ...
    inpDef inpCollate(inpSelf, index):
        ...
        rays = inpGet_rays(poses, inpSelf.inpIntrinsics, inpSelf.H, inpSelf.W, inpSelf.num_rays, error_map, inpSelf.opt.patch_size)
